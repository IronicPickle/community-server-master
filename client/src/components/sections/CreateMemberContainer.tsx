...
class CreateMemberContainer extends Component<PropsI, StateI> {
  static contextType = GlobalContext;

  private defaultInputs: any = { discordId: "", inaraName: "", inGameName: "" };
  ...
  onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    createMember(this.state.inputs, (res: { success: boolean, msg: string, errors: any }) => {
          ...
          <Paper className={classes.subContainer}>
            <Grid container direction="column" alignItems="center">
              ...
              <Grid item>
                ...
                >Create a new member to the database</Typography>
              </Grid>
            </Grid>
