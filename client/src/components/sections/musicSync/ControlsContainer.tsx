...
class ControlsContainer extends Component<PropsI> {
  ...
  onToggleVolume() {
    ...
    if(parent.state.instanceData.isMuted) {
  ...
  render() {
    ...
    const { instanceData, player, trackPosition, volumePosition } = parent.state;
          ...
          <Paper className={classes.mainContainer}>
            <Toolbar className={classes.toolbar}>
              <IconButton
                ...
                disabled={!authenticate("musicbot-skip", memberData)}
              >
                {
                  (instanceData.isPlaying) ?
              ...
              <IconButton
                ...
                aria-label="restart"
                className={classes.button}
                disabled={!authenticate("musicbot-restart", memberData)}
              >
              ...
              <Slider
                ...
                color="secondary"
                disabled={!authenticate("musicbot-seek", memberData)}
              />
              <Typography
                variant="subtitle2"
                component="p"
              ...
              <IconButton
                onClick={this.onToggleVolume}
                size="small" color="secondary"
                aria-label="toggle sound"
                className={classes.button}
                disabled={!authenticate("musicbot-mute", memberData)}
              >
                {
                  (instanceData.isMuted) ?
              ...
              <Slider
                ...
                color="secondary"
                disabled={!authenticate("musicbot-vol", memberData)}
              />
              <Typography
                variant="subtitle2"
                component="p"
              ...
              <IconButton
                onClick={this.onPlayerFullscreen}
                size="small"
                color="secondary"
                aria-label="skip"
                className={classes.button}
