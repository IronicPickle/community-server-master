...
class FooterContainer extends Component<PropsI> {
  ...
  render() {
    ...
    const { selectedInstance, selectedInstanceData, selectedUrlOption, inputUrl } = parent.state;
                  ...
                  <Grid container direction="row" alignItems="center" justify="center">
                    <Grid item>
                      <Select
                        ...
                        className={`${classes.colorWash} ${classes.urlOptionDropdown}`}
                      >
                        <MenuItem key="queue" value="queue">Queue</MenuItem>
                        <MenuItem key="queue-playlist" value="queue-playlist">Queue-Playlist</MenuItem>
                        <MenuItem key="play" value="play" disabled={!this.context.loggedIn}>Play</MenuItem>
                      </Select>
                        <TextField
                          id="url-input"
                          label="YouTube URL"
                    ...
                    <Grid container spacing={2} direction="row" className={classes.queueGridContainer}>
                      {
                        queue.map((queueItem: any, i: number) => {
                          ...
                          const entryIsPlaying = selectedInstanceData.queuePos === i;
                          return (thumbnails) ?
                              ...
                              <Grid item className={classes.queueItem}>
                                ...
                                <a href={queueItem.url} target="_blank" rel="noopener noreferrer">
                                  <Tooltip title={snippet.title} placement="top" PopperProps={{ disablePortal: true }}>
                                    <div
                                      style={{
                                        backgroundImage: `url(${thumbnails.standard.url})`,
