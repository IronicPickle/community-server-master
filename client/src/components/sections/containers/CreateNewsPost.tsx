...
import HTTPNewsPosts, { CreateErrors, CreateOptions } from "../../../http_utils/HTTPNewsPosts";
...
class CreateNewsPost extends Component<Props, State> {
  ...
  async onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await HTTPNewsPosts.create(this.state.inputs);
        ...
        <Dialog open={state} onClose={onClose}>
          <DialogContent>
            <Container className={classes.mainContainer} >
              ...
              >
                Broadcast a Post to the Whole Community
              </Typography>
...
export default withStyles(styles, { withTheme: true })(CreateNewsPost);