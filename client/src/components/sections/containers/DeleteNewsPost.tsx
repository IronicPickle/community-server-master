...
import HTTPNewsPosts, { DeleteOptions } from "../../../http_utils/HTTPNewsPosts";
...
class DeleteNewsPost extends Component<Props> {
  ...
  async onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await HTTPNewsPosts.delete(this.props.inputs._id);
        ...
        <Dialog open={state} onClose={onClose}>
          <DialogContent>
            <Container className={classes.mainContainer} >
              ...
              <form name="deleteNewsPost" onSubmit={this.onSubmit} onError={this.onSubmit}>
...
export default withStyles(styles, { withTheme: true })(DeleteNewsPost);