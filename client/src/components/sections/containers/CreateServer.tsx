...
import { Grid, Typography, Theme, Button, Container, FormControl, FormHelperText, TextField, Dialog, DialogContent, Toolbar, Select, MenuItem } from "@material-ui/core";
import { globalContext } from "../../../utils/contexts";
import { ClassNameMap } from "@material-ui/core/styles/withStyles";
import HTTPServers, { CreateErrors, CreateOptions, serverTypes } from "../../../http_utils/HTTPServers";
...
class CreateServer extends Component<Props, State> {
  static contextType = globalContext;

  private defaultInputs = { name: "", description: "", type: "minecraft" as "minecraft", address: "", port: "" };
  ...
  async onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const res = await HTTPServers.create(this.state.inputs);
        ...
        <Dialog open={state} onClose={onClose}>
          <DialogContent>
            <Container className={classes.mainContainer} >
              ...
              >
                Create a Server to Display Various Info
              </Typography>

              <form name="createServer" onSubmit={this.onSubmit} onError={this.onSubmit}>
...
export default withStyles(styles, { withTheme: true })(CreateServer);