...
import HTTPServers, { CreatePostErrors, CreatePostOptions, DBServer } from "../../../http_utils/HTTPServers";
...
interface State {
  inputs: CreatePostOptions;
  validation: CreatePostErrors;
}

class CreateServerPost extends Component<Props, State> {
  static contextType = globalContext;

  private defaultInputs = { title: "", body: "" };
  ...
  async onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await HTTPServers.createPost({ ...this.state.inputs, serverId: this.props.server._id });
        ...
        <Dialog open={state} onClose={onClose}>
          <DialogContent>
            <Container className={classes.mainContainer} >
              ...
              >
                Broadcast a Post to a specific Server channel
              </Typography>

              <form name="createServerPost" onSubmit={this.onSubmit} onError={this.onSubmit}>
...
export default withStyles(styles, { withTheme: true })(CreateServerPost);